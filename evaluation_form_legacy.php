    ...
    <main>
      <div class="contact-form-container evaluation-page">
        ...
        <div class="button-container">
          <a href="evaluations.php" class="page-button back-button evaluation-actions__back-link" data-destination="evaluations.php" data-back-target="evaluations.php">Indietro</a>
        </div>
        <form id="evaluation-form" class="contact-form" action="evaluation_handler.php" method="post">
          ...
          <div class="evaluation-actions" aria-label="Navigazione e azioni di salvataggio">
            ...
            <div class="evaluation-actions__main">
              <?php if ($isAlreadySubmittedEvaluation): ?>
              <button class="submit-btn" type="submit" name="action" value="save">Salva valutazione</button>
              <?php else: ?>
