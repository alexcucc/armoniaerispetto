      ...
      <div class="hero">
        ...
        <div class="content-container">
          <div class="overlay-wrapper">
            <div class="overlay-image">
              <img class="image fade-right" src="images/gorilla.jpg">
            </div>
            <div class="overlay-text-right">
              ...
              <ul>
                ...
                <li>partecipare ad attività tese a combattere le cause della discriminazione ed ingiustizia sociale favorendo i processi di partecipazione e inclusione ad una vita sociale sana e riducendo gli svantaggi sociali e educativi delle popolazioni deboli
                <li>la promozione di un'agricoltura rispettosa della biodiversità e dell'ambiente, attenta alla salute delle persone, socialmente equa e compatibile con la fauna presente nell'ambiente circostante
              </ul>
            </div>
          </div>
        </div>
        <div class="content-container">
          <div class="overlay-wrapper">
            ...
            <div class="overlay-image">
              <img class="image fade-left" src="images/turtle.jpg">
            </div>
          </div>
        </div>
        <div class="content-container">
          <div class="overlay-wrapper">
            <div class="overlay-image">
              <img class="image fade-right" src="images/whales.jpg">
            </div>
            <div class="overlay-text-right">
